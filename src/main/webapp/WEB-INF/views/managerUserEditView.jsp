...
<div class="container-fluid">
  <div class="row d-flex d-md-block flex-nowrap wrapper">
    ...
    <main id="main" class="col-md-9 float-left col pl-md-5 pt-3 main">
      ...
      <hr>
      <form action="./managerUserEditAction.reservation" method="POST" class="pt-3" style="max-width:720px;">
        <div class="form-group">
          <input name="userID" type="text"  value="${user.userID}" class="form-control">
          <div class="form-group">
            <label>비밀번호</label>
