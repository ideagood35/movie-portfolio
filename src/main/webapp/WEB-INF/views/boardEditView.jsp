      ...
      <div class="row d-flex d-md-block flex-nowrap wrapper">
        ...
        <main id="main" class="col-md-9 float-left col pl-md-5 pt-3 main">
          ...
          <form action="boardEditAction.reservation" method="POST" class="pt-3" style="max-width:920px;">
            <input name="bbsID" type="hidden" value=${param.bbsID}>
            <div class="form-group">
              <label>제목</label>
              <input name="bbsTitle" type="text" class="form-control" placeholder="제목을 입력하세요." value="${ bbs.bbsTitle }">
            </div>
            <div class="form-group">
              <label>내용</label>
              <textarea name="bbsContent" class="form-control" style="height:320px" placeholder="내용을 입력하세요.">${ bbs.bbsContent }</textarea>
            </div>
